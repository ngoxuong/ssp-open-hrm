...
function Folder(folderDescription, hreference,ext)
{
  this.ext = ext;
...
function drawFolder(leftSide)
{
  ...
  doc.write("<TR class='textms' LAYER SPAN ONMOUSEOVER=this.style.backgroundColor='#DAEAF8' ONMOUSEOUT=this.style.backgroundColor='#EEF5FB'><TD width=1%>")
  doc.write(leftSide)
  this.outputLink()
  doc.write("<img name='folderIcon" + this.id + "' ")
  doc.write("src='" + this.iconSrc+"' border=0> &nbsp;</a>")
  doc.write("</TD><TD VALIGN=middle nowrap width=11%>")
  if (USETEXTLINKS)
  {
    this.outputLink()
  ...
  doc.write("</TD>")
  doc.write("<TD width=88% align=right >"+this.ext+"</TD>")
  doc.write("</TR></TABLE>")
...
function Item(itemDescription, itemLink,extDesc)
{
  /* constant data */
...
function drawItem(leftSide)
{
  ...
  if (USETEXTLINKS && this.link)
    ...
    doc.write("<NOBR>" + this.desc + "</NOBR>")
  doc.write("</TD><TD align=right>"+this.extDesc+"</TD>")	
  doc.write("</TR></TABLE>")
...
function gFld(description, ref,ext)
{
  if (DWIN && ref) ref = "javascript:go(\""+ref+"\")"

  folder = new Folder(description, ref,ext)
  return folder
}

function gLnk(target, description, ref,extDesc)
{
  fullLink = ""
  ...
  linkItem = new Item(description, fullLink,extDesc)
  return linkItem
}
...
//var str1 ="<table width =50% border =0><tr><td class=textms align=right>Nhan su | Xem | Sua</td></tr></table>";
var str1 ="";
var str2 = "";
