...
var ssp_token='<--token-->';//haitt edit here for parse argument to text and value
...
function DOL_addOptions() {
	...
	for (var i=0; i<arguments.length; i++) {
		var temp = arguments[i];	//haitt edit here for parse argument to text and value	
		var token = ssp_token; 		//haitt edit here for parse argument to text and value
		var text = temp;			//haitt edit here for parse argument to text and value
		var value = text;			//haitt edit here for parse argument to text and value
		var positionoftoken = temp.indexOf(token);//haitt edit here for parse argument to text and value
		if(positionoftoken>0){		//haitt edit here for parse argument to text and value
		var text = temp.substring(0,positionoftoken);//haitt edit here for parse argument to text and value
		var value = temp.substring(positionoftoken+token.length,temp.length);//haitt edit here for parse argument to text and value
		}//haitt edit here for parse argument to text and value
		...
		*/
		...
		this.addNewOptionToList(this.currentNode.options,text,value,false);//haitt edit here for parse argument to text and value
