inherited frmContractGenerate: TfrmContractGenerate
    ...
    object tabHopdongMau: TElTabSheet
      ...
      object dxLayoutControl1: TdxLayoutControl
        ...
        object pageTemplate: TElPageControl
          ...
          object tabVitriCongtac: TElTabSheet
            ...
            object dxLayoutControl4: TdxLayoutControl
              ...
              object ElPopupButton2: TElPopupButton
                ...
                NumGlyphs = 1
                UseXPThemes = True
                Caption = 'X'#243'a v'#7883' tr'#237' b'#7893' nhi'#7879'm'
                TabOrder = 3
                Color = 15466238
                ParentColor = False
                Action = acXoaViTriBoNhiem
          ...
          object tabLuongCBNN: TElTabSheet
            PageControl = pageTemplate
            ImageIndex = -1
            TabVisible = True
            Caption = 'H'#7879' s'#7889' l'#432#417'ng CBNN'
            Visible = False
            object dxLayoutControl6: TdxLayoutControl
              ...
              object ElPopupButton3: TElPopupButton
                ...
                NumGlyphs = 1
                UseXPThemes = True
                Caption = 'X'#243'a h'#7879' s'#7889' l'#432#417'ng CBNN'
                TabOrder = 6
                Color = 15466238
                ParentColor = False
                Action = acXoaNgachLuong
                DockOrientation = doNoOrient
                DoubleBuffered = False
              end
              object dxLayoutControl6Group_Root: TdxLayoutGroup
                ...
                object dxLayoutControl6Group1: TdxLayoutGroup
                  AutoAligns = [aaHorizontal]
                  AlignVert = avClient
                  Caption = 'Th'#244'ng tin h'#7879' s'#7889' l'#432#417'ng CBNN'
                  ...
                  object dxLayoutControl6Group4: TdxLayoutGroup
                    Caption = 'New Group'
                    ShowCaption = False
                    Hidden = True
                    ShowBorder = False
                    object dxLayoutControl6Item7: TdxLayoutItem
                      AutoAligns = [aaVertical]
                      AlignHorz = ahRight
                      Caption = 'New Item'
                      ShowCaption = False
  ...
  object qryTemplate: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '     , HR_CONTRACT_TEMPLATE.wage_scale '
      '     , HR_CONTRACT_TEMPLATE.wage_level '
      '     , HR_CONTRACT_TEMPLATE.wage_coeff '
      '     , HR_CONTRACT_TEMPLATE.apply_month '
      '     , HR_CONTRACT_TEMPLATE.apply_year '
      '     , HR_CONTRACT_TEMPLATE.apply_period'
      ...
      'left join HR_TITLE on HR_POSITION.TITLE_NO=HR_TITLE.TITLE_NO'
        ...
        'left join hr_career on hr_contract_template.wage_scale = hr_care' +
        'er.career_no ')
    FieldOptions = []
    Left = 7
    Top = 216
    ...
    object qryTemplateWAGE_SCALE: TWideStringField
      FieldName = 'WAGE_SCALE'
      Size = 30
    end
    object qryTemplateWAGE_LEVEL: TIntegerField
      FieldName = 'WAGE_LEVEL'
    end
    object qryTemplateWAGE_COEFF: TIBOFloatField
      FieldName = 'WAGE_COEFF'
    end
    object qryTemplateAPPLY_MONTH: TSmallintField
      FieldName = 'APPLY_MONTH'
    end
    object qryTemplateAPPLY_YEAR: TIntegerField
      FieldName = 'APPLY_YEAR'
    end
    object qryTemplateAPPLY_PERIOD: TSmallintField
      FieldName = 'APPLY_PERIOD'
    end
    object qryTemplateCAREER_NAME: TWideStringField
      FieldName = 'CAREER_NAME'
      Size = 126
    end
  end
  ...
  object ActionList1: TActionList
    ...
    object acXoaViTriBoNhiem: TAction
      Caption = 'XoaViTriBoNhiem'
      ImageIndex = 11
      OnExecute = acXoaViTriBoNhiemExecute
    end
    object acXoaNgachLuong: TAction
      Caption = 'acXoaNgachLuong'
      ImageIndex = 11
      OnExecute = acXoaNgachLuongExecute
    end
    object acXoaThamSo: TAction
      Caption = 'acXoaThamSo'
      OnExecute = acXoaThamSoExecute
    end
  end
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxXoaThamSo: TdxBarButton
      Action = acXoaThamSo
      Caption = 'X'#243'a danh s'#225'ch tham s'#7889
      Category = 0
      Hint = 'X'#243'a danh s'#225'ch tham s'#7889
      Visible = ivAlways
    end
  end
  ...
  object qryWageStandardChange: TIBOQuery
    ...
    SQL.Strings = (
      'select change_no'
        ...
        'from hr_them_dot_tangluong(:contract_no,:contract_date,:contract' +
        '_name, '#39'CONTRACT'#39')')
    FieldOptions = []
    Left = 39
    Top = 344
  ...
  object qryWageStandardDetail: TIBOQuery
    Params = <
      item
        DataType = ftUnknown
        Name = 'CHANGE_NO'
