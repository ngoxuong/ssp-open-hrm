...
type
  TfrmMaychamcong = class(TfrmBase)
...
var
  frmMaychamcong: TfrmMaychamcong;
...
procedure TfrmMaychamcong.acBackUpdate(Sender: TObject);
begin
  inherited;
  acBack.Enabled:=(pageMain.ActivePageIndex>0);
end;

procedure TfrmMaychamcong.acNextUpdate(Sender: TObject);
begin
  inherited;
  acNext.Enabled:=(pageMain.ActivePageIndex<pageMain.PageCount-1);
end;

procedure TfrmMaychamcong.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmMaychamcong.acNextExecute(Sender: TObject);
begin
  inherited;
  pageMain.ActivePage := tabStep2;
end;

procedure TfrmMaychamcong.acBackExecute(Sender: TObject);
begin
  inherited;
    pageMain.ActivePage := tabStep1;
end;

procedure TfrmMaychamcong.dxExcelFileNameButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
  inherited;
...
procedure TfrmMaychamcong.acDocDuLieuExecute(Sender: TObject);
begin
  inherited;
  ////////////////
  ModalResult := mrOk;
...
procedure TfrmMaychamcong.qryLoaiMayMACHINE_MODELChange(
  Sender: TField);
begin
  inherited;
  qryLoaiMay.Post;
...
procedure TfrmMaychamcong.qryLoaiMayMACHINE_NAMEChange(Sender: TField);
begin
  inherited;
  qryLoaiMay.Post;
end;

procedure TfrmMaychamcong.qryLoaiMayFILE_STYLEChange(Sender: TField);
begin
  inherited;
  qryLoaiMay.Post;
end;

procedure TfrmMaychamcong.gridMachineStyleDblClick(Sender: TObject);
begin
  inherited;
  PopupProcess(self,true,sender);
end;

procedure TfrmMaychamcong.dxdbLoaiMayInitPopup(Sender: TObject);
begin
  inherited;
  If qryLoaiMay.Active then
    qryLoaiMay.Close;
