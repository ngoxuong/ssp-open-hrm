inherited frmBAOHIEM_DSPHSK_SauTS: TfrmBAOHIEM_DSPHSK_SauTS
  Left = 129
  Top = 111
  Width = 1014
  Height = 636
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Qu'#7843'n l'#253' ngh'#7881' d'#432#7905'ng s'#7913'c ph'#7909'c h'#7891'i s'#7913'c kh'#7887'e sau thai s'#7843'n'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
  end
  ...
  object qryChiTiet: TIBOQuery
    ...
    DatabaseName = 'E:\SSP_HRM_30_BHXH\Database\SSP_HRM_DB_30.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM HR_BAOHIEM_NDSPHSK_SAU_TS'
      'WHERE'
      '   KEY_ID = :OLD_KEY_ID')
    EditSQL.Strings = (
      'UPDATE HR_BAOHIEM_NDSPHSK_SAU_TS SET'
      '   KEY_ID = :KEY_ID, /*PK*/'
    ...
    GeneratorLinks.Strings = (
      'KEY_ID = GEN_HR_BH_NDSPHSK_SAU_TS_ID')
    IB_Connection = dmMain.connMain
    InsertSQL.Strings = (
      'INSERT INTO HR_BAOHIEM_NDSPHSK_SAU_TS('
      '   KEY_ID, /*PK*/'
      '   ID_BAOHIEM_SODANGKY,'
      '   NGHI_TUNGAY,'
      '   NGHI_DENNGAY,'
      ...
      '   :GHI_CHU)')
    KeyLinks.Strings = (
      'hr_baohiem_ndsphsk_sau_ts.key_id')
    ...
    DataSource = dsSoDangKyBHXH
    SQL.Strings = (
      'select hr_baohiem_ndsphsk_sau_ts.key_id,'
      '    hr_baohiem_ndsphsk_SAU_TS.id_baohiem_sodangky,'
      '    hr_baohiem_ndsphsk_SAU_TS.nghi_tungay,'
      '    hr_baohiem_ndsphsk_SAU_TS.nghi_denngay,'
      '    hr_baohiem_ndsphsk_SAU_TS.so_ngaynghi,'
      '    hr_baohiem_ndsphsk_SAU_TS.so_ngaynghi_taigiadinh,'
      '    hr_baohiem_ndsphsk_SAU_TS.so_ngaynghi_taptrung,'
      '    hr_baohiem_ndsphsk_SAU_TS.loai_doituong,'
      '    hr_work_hour_type.wht_name,'
      '    hr_baohiem_ndsphsk_SAU_TS.ten_vanban_dinhkem,'
      '    hr_baohiem_ndsphsk_SAU_TS.vanban_dikem,'
      '    hr_baohiem_ndsphsk_SAU_TS.ghi_chu'
      'from hr_baohiem_ndsphsk_SAU_TS'
      
        'left join hr_work_hour_type on hr_baohiem_ndsphsk_SAU_TS.loai_do' +
        'ituong = hr_work_hour_type.wht_no'
      
        'where hr_baohiem_ndsphsk_SAU_TS.id_baohiem_sodangky = :id_baohie' +
        'm_sodangky'
      
        'and (hr_baohiem_ndsphsk_SAU_TS.nghi_tungay between :TU_NGAY and ' +
        ':DEN_NGAY'
      '     or'
      
        '     hr_baohiem_ndsphsk_SAU_TS.nghi_denngay between :TU_NGAY and' +
        ' :DEN_NGAY)')
    FieldOptions = []
    Left = 40
    Top = 168
  ...
  object qryTongHop: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '    ghi_chu'
        ...
        'from hr_baohiem_get_dsphsk_sauts(:XEM_THEO_DONVI,:XEM_CAPDUOI,:X' +
        'EM_TUYCHON_NGHIVIEC,'
