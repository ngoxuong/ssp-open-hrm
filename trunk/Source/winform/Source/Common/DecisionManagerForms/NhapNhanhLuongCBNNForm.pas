...
uses
  ...
  IBODataset, ActnList, DB, dxmdaset, dxCntner, dxEditor, dxEdLib,
  dxGrClms, ElPgCtl, dxDBCtrl, dxDBTLCl, dxDBTL, ExtCtrls, dxLayoutControl,
  ElBtnCtl, ElPopBtn, dxTL, dxDBGrid, cxControls, dxfProgressBar;

type
  TfrmNhapNhanhLuongCBNN = class(TfrmBase)
...
var
  frmNhapNhanhLuongCBNN: TfrmNhapNhanhLuongCBNN;
...
procedure TfrmNhapNhanhLuongCBNN.acLoadDSCanhanExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmNhapNhanhLuongCBNN.acInitFinalListExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmNhapNhanhLuongCBNN.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmNhapNhanhLuongCBNN.treeFinalCustomDrawCell(Sender: TObject;
...
procedure TfrmNhapNhanhLuongCBNN.acAddExecute(Sender: TObject);
var
  i : integer;
begin
  inherited;
  ...
  begin
    ...
    begin
      ...
      memFinalTHANG_APDUNG.Value:= MonthOf(Today);
      memFinalNAM_APDUNG.Value:= YearOf(Today);
...
procedure TfrmNhapNhanhLuongCBNN.treeFinalChangeNode(Sender: TObject;
...
procedure TfrmNhapNhanhLuongCBNN.acAddAllExecute(Sender: TObject);
begin
  inherited;
...
procedure TfrmNhapNhanhLuongCBNN.acRemoveExecute(Sender: TObject);
var i:integer;
  temp:string;
  temp_date:TDate;
begin
...
procedure TfrmNhapNhanhLuongCBNN.acRemoveAllExecute(Sender: TObject);
begin
  inherited;
  memFinal.DisableControls;
  memDSCanhan.DisableControls;
...
procedure TfrmNhapNhanhLuongCBNN.acBoquaExecute(Sender: TObject);
begin
  inherited;
  ModalResult:=mrCancel;
end;

procedure TfrmNhapNhanhLuongCBNN.acAddUpdate(Sender: TObject);
begin
  inherited;
...
procedure TfrmNhapNhanhLuongCBNN.acRemoveUpdate(Sender: TObject);
var
  i : integer;
begin
  inherited;
...
procedure TfrmNhapNhanhLuongCBNN.acRemoveAllUpdate(Sender: TObject);
begin
  inherited;
  acRemoveALL.Enabled:=not memFinal.IsEmpty;
end;

procedure TfrmNhapNhanhLuongCBNN.acChapnhanExecute(Sender: TObject);
begin
  inherited;
  memFinal.DisableControls;
...
//  INSERT INTO HR_WAGE_STANDARD_DETAIL (CHANGE_NO, EMPLOYEE_NO, WAGE_SCALE, WAGE_LEVEL, WAGE_COEFF, APPLY_MONTH, APPLY_YEAR, APPLY_PERIOD)
...
procedure TfrmNhapNhanhLuongCBNN.memDSCanhanBeforeDelete(
  DataSet: TDataSet);
begin
  inherited;
//
...
procedure TfrmNhapNhanhLuongCBNN.memFinalBeforeDelete(DataSet: TDataSet);
begin
  inherited;
//
end;
