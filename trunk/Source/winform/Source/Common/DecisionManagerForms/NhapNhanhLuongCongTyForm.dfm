inherited frmNhapNhanhLuongCongTy: TfrmNhapNhanhLuongCongTy
  Left = 227
  Top = 139
  Width = 929
  Height = 602
  ...
  object dxlcSelectPosition: TdxLayoutControl [1]
    Left = 272
    Top = 96
    Width = 300
    Height = 250
  ...
  object dxLayoutControl1: TdxLayoutControl [2]
    ...
    object panelMain: TPanel
      ...
      object treeFinal: TdxDBTreeList
        ...
        object treeFinalITEM_NAME: TdxDBTreeListMaskColumn
          Caption = 'Ch'#7913'c danh / Nh'#226'n vi'#234'n'
          Color = clInfoBk
          DisableEditor = True
          HeaderAlignment = taCenter
          Width = 232
          ...
          RowIndex = 0
          FieldName = 'ITEM_NAME'
          Caption_UTF7 = 'Ch+Huk-c danh / Nh+AOI-n vi+AOo-n'
        end
        ...
        object tabDSCanhanCTN: TElTabSheet
          ...
          object gridDSCanhan: TdxDBGrid
            ...
            object gridDSCanhanWAGE_COEFF: TdxDBGridColumn
              Caption = 'M'#7913'c l'#432#417'ng'
              HeaderAlignment = taCenter
              Width = 50
              BandIndex = 0
              RowIndex = 0
              FieldName = 'WAGE_COEFF'
              Caption_UTF7 = 'M+Huk-c l+AbABoQ-ng'
            end
          end
        end
      end
    ...
    object dxLayoutGroup5: TdxLayoutGroup
      ...
      object dxLayoutGroup6: TdxLayoutGroup
        Caption = '* Th'#244'ng tin t'#249'y ch'#7885'n h'#7879' s'#7889' SXKD'
        LayoutDirection = ldHorizontal
        ...
        object dxLayoutControl1Item3: TdxLayoutItem
          Caption = 'B'#7853'c l'#432#417'ng - H'#7879' s'#7889
          Control = dxWage
          ControlOptions.ShowBorder = False
        end
      end
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Nh'#7853'p nhanh h'#7879' s'#7889' SXKD'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
  end
  ...
  object qryInsertWageDetail: TIBOQuery
    ...
    DatabaseName = 'E:\NhuaBinhMinh\Code\Database\SSP_HRM_DB_30.GDB'
    ...
    SQL.Strings = (
        ...
        'INSERT INTO HR_COMP_WAGE_STANDARD_DETAIL (CHANGE_NO, EMPLOYEE_NO' +
        ', WAGE_SCALE, WAGE_LEVEL, WAGE_COEFF, APPLY_MONTH, APPLY_YEAR, A' +
        'PPLY_PERIOD)'
  ...
  object qryCareer: TIBOQuery
    ...
    SQL.Strings = (
      'select hr_company_wage_standard.wage_scale,'
        ...
        '    hr_company_wage_standard.wage_scale || '#39'-'#39' || hr_company_wag' +
        'e_scale.wage_scale_name career_name,'
      '    hr_company_wage_standard.wage_level,'
      '    hr_company_wage_standard.wage_coeff,'
      
        '    '#39'B'#225#186#173'c: '#39' || hr_company_wage_standard.wage_level || '#39' - H'#225#187#8225 +
        ' s'#225#187#8216': '#39' ||'
      '    (select sp_substring.result'
      
        '     from sp_substring(hr_company_wage_standard.wage_coeff,1,4))' +
        ' WAGE_ITEM'
      'from hr_company_wage_standard join hr_company_wage_scale'
      
        'on hr_company_wage_standard.wage_scale = hr_company_wage_scale.w' +
        'age_scale'
      
        'order by  hr_company_wage_standard.wage_scale,hr_company_wage_st' +
        'andard.wage_level')
    FieldOptions = []
    Left = 54
    Top = 230
  ...
  object qryDSCaNhan: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '    WAGE_LEVEL,'
      '    WAGE_COEFF'
      'FROM HR_DS_CANHAN_TANGLUONG_CONGTY(:DECISION_NO,:DECISION_DATE)'
