inherited frmChucvuCDoan: TfrmChucvuCDoan
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Danh m'#7909'c ch'#7913'c v'#7909' C'#244'ng '#273'o'#224'n '
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 48
  ...
  inherited qryList: TIBOQuery
    DeleteSQL.Strings = (
      'DELETE FROM HR_CHUCVU_CDOAN'
      'WHERE'
      '   MA_CHUCVU = :OLD_MA_CHUCVU')
    EditSQL.Strings = (
      'UPDATE HR_CHUCVU_CDOAN SET'
