inherited frmEditor: TfrmEditor
  ...
  object cmbFont: TRVFontComboBox [1]
    Left = 538
    Top = 72
    Width = 145
    Height = 21
  ...
  object cmbFontSize: TRVFontSizeComboBox [2]
    Left = 465
    Top = 72
    Width = 72
    Height = 21
  ...
  object dxLayoutControl1: TdxLayoutControl [3]
    ...
    object dbrvMain: TDBRichViewEdit
      Left = 12
      Top = 12
      Width = 775
      Height = 432
    ...
    object RVHorizontalRuler: TRVRuler
      Left = 10
      Top = 352
      Width = 600
      Height = 25
      ...
      ParentColor = False
      RightMargin = 2.540000000000000000
  ...
  object ActionList1: TActionList
    ...
    object SaveTemplate: TAction
      Category = 'Data'
      Caption = 'SaveTemplate'
      OnExecute = SaveTemplateExecute
      OnUpdate = SaveTemplateUpdate
    end
    object LoadTemplate: TAction
      Category = 'Data'
      Caption = 'LoadTemplate'
      OnExecute = LoadTemplateExecute
      OnUpdate = LoadTemplateUpdate
    end
  end
  ...
  object dxBarManager1: TdxBarManager
    ...
    Bars = <
      ...
      item
        Caption = 'C'#244'ng c'#7909' l'#7845'y m'#7851'u so'#7841'n th'#7843'o'
        DockControl = dxBarDockControl1
        DockedDockControl = dxBarDockControl1
        DockedLeft = 613
        DockedTop = 26
        ...
        Name = 'C'#244'ng c'#7909' l'#7845'y m'#7851'u so'#7841'n th'#7843'o'
        OneOnRow = False
        Row = 1
        UseOwnFont = False
        Visible = True
    ...
    object dxBarButton65: TdxBarButton
      Action = LoadTemplate
      Caption = 'L'#7845'y m'#7851'u'
      Category = 0
      Hint = 'L'#7845'y m'#7851'u'
      Visible = ivAlways
      ImageIndex = 84
      Lowered = True
    ...
    object dxBarButton66: TdxBarButton
      Action = SaveTemplate
      Caption = 'L'#432'u m'#7851'u'
      Category = 0
      Hint = 'L'#432'u m'#7851'u'
      Visible = ivAlways
      ImageIndex = 85
      Lowered = True
      PaintStyle = psCaptionGlyph
