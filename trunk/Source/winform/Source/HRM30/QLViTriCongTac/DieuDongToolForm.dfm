inherited frmDieuDongTool: TfrmDieuDongTool
  Left = 225
  Top = 159
  Width = 786
  Height = 575
  ...
  object dxLayoutControl1: TdxLayoutControl [2]
    ...
    object panelMain: TPanel
      ...
      object ElPanel1: TElPanel
        ...
        object treeFinal: TdxDBTreeList
          ...
          DragMode = dmAutomatic
          TabOrder = 0
          OnDragDrop = treeFinalDragDrop
          OnDragOver = treeFinalDragOver
          OnEndDrag = treeFinalEndDrag
          DataSource = dsFinal
          LookAndFeel = lfFlat
          ...
          ShowBands = True
          TreeLineColor = clGrayText
          OnBeginDragNode = treeFinalBeginDragNode
          ...
          object treeFinalOLD_ITEM_NO: TdxDBTreeListMaskColumn
            DisableCaption = True
            DisableCustomizing = True
            DisableDragging = True
            DisableEditor = True
    ...
    object ElPopupButton1: TElPopupButton
      ...
      NumGlyphs = 1
      UseXPThemes = True
      Caption = 'DM v'#7883' tr'#237' c'#244'ng t'#225'c'
      TabOrder = 0
      Color = 15466238
      ParentColor = False
      Action = acDMViTri
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Ti'#7879'n '#237'ch '#273'i'#7873'u '#273#7897'ng v'#7883' tr'#237' c'#244'ng t'#225'c'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 8
  ...
  object memFinal: TdxMemData
    ...
    object memFinalOLD_ITEM_NO: TIntegerField
      FieldName = 'OLD_ITEM_NO'
    end
    ...
    object memFinalIS_MAIN_POSITION: TSmallintField
      FieldName = 'IS_MAIN_POSITION'
    end
  end
  ...
  object qryDeptList: TIBOQuery
    ...
    SQL.Strings = (
      'select'
      '  hr_mask_dept_list.dept_no,'
      '  hr_mask_dept_list.p_dept_no,'
      '  hr_mask_dept_list.dept_name,'
      '  hr_position.position_no,'
      '  hr_title.title_no,'
      '  hr_title.title_name'
      'from hr_mask_dept_list(:user_name,null,1)'
      
        'left join hr_position on hr_position.dept_no=hr_mask_dept_list.d' +
        'ept_no'
      'left join hr_title on hr_position.title_no=hr_title.title_no'
      'where hr_mask_dept_list.ended_date is null'
      
        'order by hr_mask_dept_list.display_index,hr_mask_dept_list.dept_' +
        'name, hr_title.title_name')
    FieldOptions = []
    Left = 466
    Top = 219
  ...
  object ActionList1: TActionList
    ...
    object acDMViTri: TAction
      Caption = 'acDMViTri'
      ImageIndex = 21
      OnExecute = acDMViTriExecute
    end
    object acLamMoiDSViTriDieuDong: TAction
      Caption = 'acLamMoiDSViTriDieuDong'
      OnExecute = acLamMoiDSViTriDieuDongExecute
    end
  end
