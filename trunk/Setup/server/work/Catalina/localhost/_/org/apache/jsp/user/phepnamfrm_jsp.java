...
public final class phepnamfrm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 hrm.util.DBConnectionManager dbConnManager;
  ...
  static {
    ...
    _jspx_dependants.add("/user/phepnam.jsp");
...
if(check == 1){
	...
	try{
      ...
      out.print(contextPath);
      out.write("/user/phepnamfrm.jsp\" method=\"post\">\n");
...
if(nam.equals(tempnam)){
      ...
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<tr><td height=\"1\" bgcolor=\"#CCCCCC\" colspan=\"3\"></td></tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t");
      ...
      out.write("\n");
      out.write("\t\t\t\t\t\t<td class=\"des\" align=\"right\" bgcolor=\"#f8f8f8\">\n");
      out.write("\t\t\t\t\t\t\t");
      out.print(_res("pn.ngayphep"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\" bgcolor=\"#FFF7E7\" class=\"value\">\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t<tr><td height=\"1\" bgcolor=\"#CCCCCC\" colspan=\"3\"></td></tr>\n");
      out.write("\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t<td width=\"18%\" align=\"right\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("pn.danghi"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t  \t<td bgcolor=\"#FFF7E7\" class=\"value\" colspan=\"2\">\n");
      out.write("\t\t\t\t\t\t\t");
      ...
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"111\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("pn.nghiphep"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"160\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("pn.thoigiannghi"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"75\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
...
if(j%2==0){out.println("bgcolor='#EEEEEE'");}else{out.println("bgcolor='#FFFFFF'");}
      ...
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#FFF7E7\" class=\"value\">");
      out.print(SString.toString(rs.getDate(3),"dd/MM/yyyy") );
      out.write(' ');
      out.print(_res("dkp.den"));
      out.print(SString.toString(rs.getDate(4),"dd/MM/yyyy") );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td align=\"center\"bgcolor=\"#FFF7E7\" class=\"value\">");
      out.print(rs.getDouble(5) );
      out.write("</td>\n");
...
if(rs.getString(6)==null || rs.getString(6).equals("null")){
      ...
      out.print(_res("pn.songaynghi"));
      out.write("</td>\n");
      out.write("                        <td width=\"173\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("pn.lydonghi"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("pn.lydokhongduyet"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"59\" align=\"center\" bgcolor=\"#f8f8f8\" class=\"des\">");
