...
public final class uyquyenduyetphepfrm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 hrm.util.DBConnectionManager dbConnManager;
  ...
  static {
    ...
    _jspx_dependants.add("/user/uyquyenduyetphep.jsp");
...
if(check == 1){
	...
	try{
      ...
      out.print(contextPath);
      out.write("/user/RegistryController.do\" method=\"post\">\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"state\" value=\"uyquyenduyetphep\">\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"username\" value=\"");
      out.print(username);
      out.write("\" />\n");
      out.write("\t\t\t\t<table align=\"center\" bgcolor=\"#F0F0F0\" width=\"790\" border=\"0\" cellpadding=6 cellspacing=1 style=\"border:1px solid #CCCCCC;\">\n");
      out.write("\t\t\t\t\t<tr>\n");
      ...
      out.write("'>\n");
      out.write("                        </td>\n");
      out.write("                        <td width=\"16%\" class=\"des\" align=\"right\">");
      ...
      out.print(_res("uq.nguoiduocuq"));
      out.write(":</td>\n");
      out.write("                        <td colspan=\"3\">\n");
      out.write("                        \t<select name=\"nguoiduocuq\">\n");
      out.write("                            \t");
      ...
      out.write("                    <tr>\n");
      out.write("                    \t<td class=\"des\" align=\"right\">");
      out.print(_res("uq.lydo"));
      out.write(":</td>\n");
      out.write("                        <td colspan=\"3\"><textarea name=\"lydouq\" style=\"width:400px;\" ></textarea></td>\n");
      out.write("                    </tr>\n");
      out.write("                    <tr><td colspan=\"4\"><hr /></td></tr>\n");
      out.write("                    <tr>\n");
      out.write("                        <td align=\"left\" colspan=\"4\">\n");
      out.write("                            <input name=\"button\" type=\"button\" value=\"");
      out.print(_res("uq.uyquyen"));
      ...
      out.print(_res("uqdp.danhsach"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t<form name=\"frmDelete\" action=\"");
      out.print(contextPath);
      out.write("/user/DeleteController.do\" method=\"post\">\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"state\" value=\"DeleteUyquyen\">\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" name=\"manv_duoc_uyquyen\">\n");
      out.write("                    <input type=\"hidden\" name=\"tungay_uyquyen\">\n");
      out.write("                    <tr height=\"24\">\n");
      out.write("\t\t\t\t\t  \t<td width=\"38\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("pn.stt"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"160\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("uq.thoigian"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"180\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("uq.nguoiduocuq"));
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td width=\"315\" align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\">");
      out.print(_res("uq.lydo"));
      out.write("</td>\t\n");
      out.write("                        <td align=\"center\" class=\"des\" bgcolor=\"#f8f8f8\" align=\"center\">");
...
if(r%2==0){
      ...
      out.print(SString.toString(rs.getDate(1),"dd/MM/yyyy") );
      out.write(' ');
      out.print(_res("dkp.den"));
      out.print(SString.toString(rs.getDate(2),"dd/MM/yyyy") );
      out.write("</td>\n");
      out.write("\t\t\t\t\t\t<td bgcolor=\"#FFF7E7\" class=\"value\">");
      ...
      out.write("\t\n");
      out.write("<script language=\"javascript\">\n");
      out.write("\tfunction funcDelete(value,date){\n");
      out.write("\t\tvar dm = document.frmDelete;\n");
      out.write("\t\tvar x=window.confirm('");
      out.print(_res("pn.confirmxoa"));
      out.write("');\n");
      out.write("\t\tif(x){\n");
      out.write("\t\t\tdm.manv_duoc_uyquyen.value = value;\n");
      out.write("\t\t\tdm.tungay_uyquyen.value = date;\n");
      out.write("\t\t\tdm.submit();\n");
      out.write("\t\t}\n");
      out.write("\t}\n");
      out.write("\t\n");
      ...
      out.write("\t\t\talert('");
      out.print(_res("uqdp.msg.dateto1"));
      out.write("');\n");
      ...
      out.write("\t\t  \talert('");
      out.print(_res("uqdp.msg.dateto2"));
      out.write("');\n");
      out.write("\t\t\tdm.denngay.focus();\n");
      out.write("\t\t  }\n");
      out.write("\t\t  \n");
      ...
      out.write("\t\t\talert('");
      out.print(_res("uqdp.msg.comparedate"));
      out.write("');\n");
      out.write("\t\t\tdm.denngay.focus();\n");
      out.write("\t\t  }\n");
      out.write("\t\t \t\t \n");
      out.write("\t\t  else if (dm.lydouq.value == ''){\n");
      out.write("\t\t\talert('");
      out.print(_res("uqdp.msg.lydo"));
      out.write("');\n");
      out.write("\t\t\tdm.lydouq.focus();\n");
      out.write("\t\t  }\n");
      out.write("\t\t  else if(dm.lydouq.value!='' && dm.lydouq.value.length>42){\n");
      out.write("\t\t  \talert('");
      out.print(_res("uqdp.msg.lengthlydo"));
      out.write("');\n");
      out.write("\t\t\tdm.lydouq.focus();\n");
      out.write("\t\t  }\n");
      out.write("\t\t  else{\n");
