...
function Folder(folderDescription, hreference)
{
  ...
  /* dynamic data */
  this.isOpen = true
  this.iconSrc = "../images/max_narrow.gif"
...
function propagateChangesInState(folder)
{
  ...
  if (folder.isOpen)
  {
    ...
    folder.iconImg.src = "../images/min_narrow.gif"
  ...
  else
  {
    ...
    folder.iconImg.src = "../images/max_narrow.gif"
    for (i=0; i<folder.nChildren; i++)
...
function Item(itemDescription, itemLink)
{
  ...
  this.iconSrc = "../images/min_narrow.gif"
