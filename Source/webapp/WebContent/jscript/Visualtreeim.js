...
function Folder(folderDescription, hreference)
{
  ...
  /* dynamic data */
  this.isOpen = true
  this.iconSrc = "/stm/images/spacer.gif"
...
function propagateChangesInState(folder)
{
  ...
  if (folder.isOpen)
  {
    if (folder.nodeImg)
      if (folder.isLastNode)
        folder.nodeImg.src = "/stm/images/ftv2mlastnode.gif"
      else
	  folder.nodeImg.src = "/stm/images/ftv2mnode.gif"
    folder.iconImg.src = "/stm/images/spacer.gif"
  ...
  else
  {
    if (folder.nodeImg)
      if (folder.isLastNode)
        folder.nodeImg.src = "/stm/images/ftv2plastnode.gif"
      else
	  folder.nodeImg.src = "/stm/images/ftv2pnode.gif"
    folder.iconImg.src = "/stm/images/spacer.gif"
    for (i=0; i<folder.nChildren; i++)
...
var nc
  ...
  if (level>0)
    ...
    {
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='/stm/images/ftv2mlastnode.gif' width=16 height=22 border=0></a>")
      leftSide = leftSide + "<img src='/stm/images/ftv2blank.gif' width=16 height=22>"
      this.isLastNode = 1
    }
    else
    {
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='/stm/images/ftv2mnode.gif' width=16 height=22 border=0></a>")
      leftSide = leftSide + "<img src='/stm/images/ftv2vertline.gif' width=16 height=22>"
      this.isLastNode = 0
    }
  else
    this.renderOb("")
...
function initializeItem(level, lastNode, leftSide)
{
  ...
  if (level>0)
    if (lastNode) //the last 'brother' in the children array
    {
      this.renderOb(leftSide + "<img src='/stm/images/ftv2lastnode.gif' width=16 height=22>")
      leftSide = leftSide + "<img src='/stm/images/ftv2blank.gif' width=16 height=22>"
    }
    else
    {
      this.renderOb(leftSide + "<img src='/stm/images/ftv2node.gif' width=16 height=22>")
      leftSide = leftSide + "<img src='/stm/images/ftv2vertline.gif' width=16 height=22>"
    }
  else
    this.renderOb("")
