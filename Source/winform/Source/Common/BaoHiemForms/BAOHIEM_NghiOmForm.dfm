inherited frmBAOHIEM_NghiOm: TfrmBAOHIEM_NghiOm
  Left = 185
  Top = 139
  Width = 1008
  Height = 634
    ...
    object pageMain: TElPageControl
      ...
      object tabChiTiet: TElTabSheet
        ...
        object gridChiTiet: TdxDBGrid
          ...
          object gridChiTietWHT_NAME: TdxDBGridMRUColumn
            Caption = 'Ph'#226'n lo'#7841'i '#7889'm'
            HeaderAlignment = taCenter
            Width = 103
            BandIndex = 0
            RowIndex = 0
            ...
            Caption_UTF7 = 'Ph+AOI-n lo+HqE-i +HtE-m'
          end
          object gridChiTietCHE_DO: TdxDBGridCalcColumn
            Alignment = taCenter
            Caption = 'Ch'#7871' '#273#7897' h'#432#7903'ng'
            HeaderAlignment = taCenter
            MinWidth = 16
            Width = 56
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CHE_DO'
            Caption_UTF7 = 'Ch+Hr8 +AREe2Q h+AbAe3w-ng'
          end
          object gridChiTietTEN_TINHTRANG: TdxDBGridMRUColumn
          ...
          object gridChiTietDIACHI_DIEUTRI: TdxDBGridColumn
            Caption = #272#7883'a ch'#7881' '#273'i'#7873'u tr'#7883
            HeaderAlignment = taCenter
            Width = 94
            BandIndex = 0
            RowIndex = 0
            FieldName = 'DIACHI_DIEUTRI'
            Caption_UTF7 = '+ARAeyw-a ch+Hsk +ARE-i+HsE-u tr+Hss'
          end
          ...
          object gridChiTietCHI_PHI: TdxDBGridCalcColumn
            Caption = 'Chi ph'#237' '#273'i'#7873'u tr'#7883
            HeaderAlignment = taCenter
            BandIndex = 0
            RowIndex = 0
            FieldName = 'CHI_PHI'
            Caption_UTF7 = 'Chi ph+AO0 +ARE-i+HsE-u tr+Hss'
          end
      ...
      object tabTongHop: TElTabSheet
        ...
        object gridTongHop: TdxDBGrid
          ...
          object gridTongHopCHE_DO: TdxDBGridCalcColumn
            Alignment = taCenter
            Caption = 'Ch'#7871' '#273#7897' h'#432#7903'ng'
            HeaderAlignment = taCenter
            MinWidth = 16
          ...
          object gridTongHopTEN_TINHTRANG: TdxDBGridColumn
            Caption = 'T'#236'nh tr'#7841'ng s'#7913'c kh'#7887'e'
            HeaderAlignment = taCenter
            Width = 99
            BandIndex = 0
          ...
          object gridTongHopDIACHI_DIEUTRI: TdxDBGridColumn
            Caption = #272#7883'a ch'#7881' '#273'i'#7873'u tr'#7883
            HeaderAlignment = taCenter
            Width = 141
            BandIndex = 0
          ...
          object gridTongHopCHI_PHI: TdxDBGridColumn
            Caption = 'Chi ph'#237' '#273'i'#7873'u tr'#7883
            HeaderAlignment = taCenter
            Width = 76
            BandIndex = 0
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Qu'#7843'n l'#253' '#273#259'ng k'#253' ngh'#7881' '#7889'm'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
  end
  ...
  object qryChiTiet: TIBOQuery
    ...
    DatabaseName = 'E:\SSP_HRM_3.0\Database\SSP_HRM_DB_30.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM HR_BAOHIEM_NGHIOM'
      'WHERE'
      '   KEY_ID = :OLD_KEY_ID')
    EditSQL.Strings = (
      'UPDATE HR_BAOHIEM_NGHIOM SET'
      '   KEY_ID = :KEY_ID, /*PK*/'
      '   ID_BAOHIEM_SODANGKY = :ID_BAOHIEM_SODANGKY,'
      '   NGHI_TUNGAY = :NGHI_TUNGAY,'
      '   NGHI_DENNGAY = :NGHI_DENNGAY,'
      '   TINHTRANG_SUCKHOE = :TINHTRANG_SUCKHOE,'
      '   DIACHI_DIEUTRI = :DIACHI_DIEUTRI,'
    ...
    GeneratorLinks.Strings = (
      'KEY_ID = GEN_HR_BAOHIEM_NGHIOM_ID')
    IB_Connection = dmMain.connMain
    InsertSQL.Strings = (
      'INSERT INTO HR_BAOHIEM_NGHIOM('
      '   KEY_ID, /*PK*/'
      '   ID_BAOHIEM_SODANGKY,'
      '   NGHI_TUNGAY,'
      '   NGHI_DENNGAY,'
    ...
    DataSource = dsSoDangKyBHXH
    SQL.Strings = (
      'select hr_baohiem_nghiom.key_id,'
      '    hr_baohiem_nghiom.id_baohiem_sodangky,'
      '    hr_baohiem_nghiom.nghi_tungay,'
      '    hr_baohiem_nghiom.nghi_denngay,'
      '    hr_baohiem_nghiom.tinhtrang_suckhoe,'
      '    hr_bhxh_tt_suckhoe.ten_tinhtrang,'
      '    hr_baohiem_nghiom.diachi_dieutri,'
      '    hr_baohiem_nghiom.yte_xacnhan,'
      '    hr_baohiem_nghiom.chi_phi,'
      '    hr_baohiem_nghiom.loai_doituong,'
      '    hr_work_hour_type.wht_name,'
      '    hr_baohiem_nghiom.che_do,'
      '    hr_baohiem_nghiom.ten_vanban_dikem,'
      '    hr_baohiem_nghiom.vanban_dikem,'
      '    hr_baohiem_nghiom.ghi_chu'
      'from hr_baohiem_nghiom'
      
        'left join hr_bhxh_tt_suckhoe on hr_baohiem_nghiom.tinhtrang_suck' +
        'hoe = hr_bhxh_tt_suckhoe.ma_tinhtrang '
      
        'left join hr_work_hour_type on hr_baohiem_nghiom.loai_doituong =' +
        ' hr_work_hour_type.wht_no '
      
        'where hr_baohiem_nghiom.id_baohiem_sodangky = :id_baohiem_sodang' +
        'ky'
      
        'and (hr_baohiem_nghiom.nghi_tungay between :TU_NGAY and :DEN_NGA' +
        'Y'
      '     or'
      
        '     hr_baohiem_nghiom.nghi_denngay between :TU_NGAY and :DEN_NG' +
        'AY)')
    FieldOptions = []
    Left = 40
    Top = 168
    ...
    object qryChiTietCHE_DO: TIBOFloatField
      FieldName = 'CHE_DO'
      Required = True
    end
    object qryChiTietTEN_TINHTRANG: TWideStringField
      FieldName = 'TEN_TINHTRANG'
      Size = 126
    end
    object qryChiTietDIACHI_DIEUTRI: TWideStringField
      FieldName = 'DIACHI_DIEUTRI'
      Size = 126
    end
    ...
    object qryChiTietCHI_PHI: TIBOFloatField
      FieldName = 'CHI_PHI'
    end
    ...
    object qryChiTietTINHTRANG_SUCKHOE: TWideStringField
      FieldName = 'TINHTRANG_SUCKHOE'
      Size = 30
    end
  ...
  object qryTongHop: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '    ghi_chu'
        ...
        'from hr_baohiem_get_nghiom(:XEM_THEO_DONVI,:XEM_CAPDUOI,:XEM_TUY' +
        'CHON_NGHIVIEC,'
    ...
    object qryTongHopCHE_DO: TIBOFloatField
      FieldName = 'CHE_DO'
    end
    object qryTongHopTEN_TINHTRANG: TWideStringField
      FieldName = 'TEN_TINHTRANG'
      Size = 126
    end
    object qryTongHopDIACHI_DIEUTRI: TWideStringField
      FieldName = 'DIACHI_DIEUTRI'
      Size = 126
    end
    ...
    object qryTongHopCHI_PHI: TIBOFloatField
      FieldName = 'CHI_PHI'
    end
