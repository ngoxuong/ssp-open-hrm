inherited frmBAOHIEM_NghiKhongLuong: TfrmBAOHIEM_NghiKhongLuong
  Left = 226
  Top = 125
  Width = 959
  Height = 640
  ...
  inherited dxlcMain: TdxLayoutControl
    ...
    inline frameDateTime1: TframeDateTime [2]
      Left = 14
      Top = 53
      Width = 469
      Height = 27
      ...
      object tabChiTiet: TElTabSheet
        ...
        object gridChiTiet: TdxDBGrid
          ...
          object gridChiTietWHT_NAME: TdxDBGridMRUColumn
            Caption = 'Ph'#226'n lo'#7841'i ngh'#7881' kh'#244'ng l'#432#417'ng'
            HeaderAlignment = taCenter
            Width = 167
            BandIndex = 0
            RowIndex = 0
            ...
            Caption_UTF7 = 'Ph+AOI-n lo+HqE-i ngh+Hsk kh+APQ-ng l+AbABoQ-ng'
          end
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Qu'#7843'n l'#253' '#273#259'ng k'#253' ngh'#7881' kh'#244'ng l'#432#417'ng'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
  end
  ...
  object qryChiTiet: TIBOQuery
    ...
    DatabaseName = 'E:\SSP_HRM_30_BHXH\Database\SSP_HRM_DB_30.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM HR_BAOHIEM_NGHI_KHONGLUONG'
      'WHERE'
      '   KEY_ID = :OLD_KEY_ID')
    EditSQL.Strings = (
      'UPDATE HR_BAOHIEM_NGHI_KHONGLUONG SET'
      '   KEY_ID = :KEY_ID, /*PK*/'
    ...
    GeneratorLinks.Strings = (
      'KEY_ID = gen_hr_baohiem_nghi_k_luong_id')
    IB_Connection = dmMain.connMain
    InsertSQL.Strings = (
      'INSERT INTO HR_BAOHIEM_NGHI_KHONGLUONG('
      '   KEY_ID, /*PK*/'
      '   ID_BAOHIEM_SODANGKY,'
      '   NGHI_TUNGAY,'
      '   NGHI_DENNGAY,'
      ...
      '   :LOAI_DOITUONG)')
    KeyLinks.Strings = (
      'hr_baohiem_nghi_khongluong.key_id')
    ...
    DataSource = dsSoDangKyBHXH
    SQL.Strings = (
      'select hr_baohiem_nghi_khongluong.key_id,'
      '    hr_baohiem_nghi_khongluong.id_baohiem_sodangky,'
      '    hr_baohiem_nghi_khongluong.nghi_tungay,'
      '    hr_baohiem_nghi_khongluong.nghi_denngay,'
      '    hr_baohiem_nghi_khongluong.ten_vanban_dikem,'
      '    hr_baohiem_nghi_khongluong.file_content,'
      '    hr_baohiem_nghi_khongluong.ghi_chu,'
      '    hr_baohiem_nghi_khongluong.loai_doituong,'
      '    hr_work_hour_type.wht_name '
      'from hr_baohiem_nghi_khongluong'
      
        'left join hr_work_hour_type on hr_baohiem_nghi_khongluong.loai_d' +
        'oituong = hr_work_hour_type.wht_no'
      
        'where hr_baohiem_nghi_khongluong.id_baohiem_sodangky = :id_baohi' +
        'em_sodangky'
      
        'and (hr_baohiem_nghi_khongluong.nghi_tungay between :TU_NGAY and' +
        ' :DEN_NGAY'
      '     or'
      
        '     hr_baohiem_nghi_khongluong.nghi_denngay between :TU_NGAY an' +
        'd :DEN_NGAY)')
    FieldOptions = []
    Left = 40
    Top = 168
    ...
    object qryChiTietFILE_CONTENT: TBlobField
  ...
  object qryTongHop: TIBOQuery
    ...
    RecordCountAccurate = True
    SQL.Strings = (
      'select hr_baohiem_get_nghi_khongluong.employee_no,'
      '    hr_baohiem_get_nghi_khongluong.full_name,'
      '    hr_baohiem_get_nghi_khongluong.maso_bhxh,'
      '    hr_baohiem_get_nghi_khongluong.nghi_tungay,'
      '    hr_baohiem_get_nghi_khongluong.nghi_denngay,'
      '    hr_baohiem_get_nghi_khongluong.loai_doituong,'
      '    hr_baohiem_get_nghi_khongluong.wht_name,'
      '    hr_baohiem_get_nghi_khongluong.ghi_chu'
      
        'from hr_baohiem_get_nghi_khongluong(:XEM_THEO_DONVI,:XEM_CAPDUOI' +
    ...
    object qryTongHopLOAI_DOITUONG: TWideStringField
      FieldName = 'LOAI_DOITUONG'
      Size = 30
    end
