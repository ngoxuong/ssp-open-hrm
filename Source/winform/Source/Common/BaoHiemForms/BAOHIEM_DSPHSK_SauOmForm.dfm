inherited frmBAOHIEM_DSPHSK_SauOm: TfrmBAOHIEM_DSPHSK_SauOm
  Left = 179
  Top = 105
  Width = 1011
  Height = 637
  ...
  inherited dxlcMain: TdxLayoutControl
    ...
    object ElPopupButton1: TElPopupButton [1]
      Left = 810
      Top = 28
      Width = 101
      Height = 25
    ...
    object dximPhanLoai: TdxImageEdit [3]
      Left = 684
      Top = 28
      Width = 126
      Style.BorderColor = 5146545
    ...
    object dxViewChild: TdxCheckEdit [4]
      Left = 337
      Top = 28
      Width = 130
      Color = 15466238
    ...
    object dxSelectDept: TdxPopupEdit [5]
      Left = 129
      Top = 28
      Width = 208
      Style.BorderColor = 5146545
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Qu'#7843'n l'#253' ngh'#7881' d'#432#7905'ng s'#7913'c ph'#7909'c h'#7891'i s'#7913'c kh'#7887'e sau '#7889'm'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
  end
  ...
  object qryChiTiet: TIBOQuery
    ...
    DatabaseName = 'E:\SSP_HRM_30_BHXH\Database\SSP_HRM_DB_30.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM HR_BAOHIEM_NDSPHSK_SAU_OMDAU'
      'WHERE'
      '   KEY_ID = :OLD_KEY_ID')
    EditSQL.Strings = (
      'UPDATE HR_BAOHIEM_NDSPHSK_SAU_OMDAU SET'
      '   KEY_ID = :KEY_ID, /*PK*/'
    ...
    GeneratorLinks.Strings = (
      'KEY_ID = GEN_HR_BH_NDSPHSK_SAU_OMDAU_ID')
    IB_Connection = dmMain.connMain
    InsertSQL.Strings = (
      'INSERT INTO HR_BAOHIEM_NDSPHSK_SAU_OMDAU('
      '   KEY_ID, /*PK*/'
      '   ID_BAOHIEM_SODANGKY,'
      '   NGHI_TUNGAY,'
      '   NGHI_DENNGAY,'
      ...
      '   :GHI_CHU)')
    KeyLinks.Strings = (
      'hr_baohiem_ndsphsk_sau_omdau.key_id')
    ...
    DataSource = dsSoDangKyBHXH
    SQL.Strings = (
      'select hr_baohiem_ndsphsk_sau_omdau.key_id,'
      '    hr_baohiem_ndsphsk_sau_omdau.id_baohiem_sodangky,'
      '    hr_baohiem_ndsphsk_sau_omdau.nghi_tungay,'
      '    hr_baohiem_ndsphsk_sau_omdau.nghi_denngay,'
      '    hr_baohiem_ndsphsk_sau_omdau.so_ngaynghi,'
      '    hr_baohiem_ndsphsk_sau_omdau.so_ngaynghi_taigiadinh,'
      '    hr_baohiem_ndsphsk_sau_omdau.so_ngaynghi_taptrung,'
      '    hr_baohiem_ndsphsk_sau_omdau.loai_doituong,'
      '    hr_work_hour_type.wht_name,'
      '    hr_baohiem_ndsphsk_sau_omdau.ten_vanban_dinhkem,'
      '    hr_baohiem_ndsphsk_sau_omdau.vanban_dikem,'
      '    hr_baohiem_ndsphsk_sau_omdau.ghi_chu'
      'from hr_baohiem_ndsphsk_sau_omdau'
      
        'left join hr_work_hour_type on hr_baohiem_ndsphsk_sau_omdau.loai' +
        '_doituong = hr_work_hour_type.wht_no'
      
        'where hr_baohiem_ndsphsk_sau_omdau.id_baohiem_sodangky = :id_bao' +
        'hiem_sodangky'
      
        'and (hr_baohiem_ndsphsk_sau_omdau.nghi_tungay between :TU_NGAY a' +
        'nd :DEN_NGAY'
      '     or'
      
        '     hr_baohiem_ndsphsk_sau_omdau.nghi_denngay between :TU_NGAY ' +
        'and :DEN_NGAY)')
    FieldOptions = []
    Left = 40
    Top = 168
  ...
  object qryTongHop: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '    ghi_chu'
        ...
        'from hr_baohiem_get_dsphsk_sauom(:XEM_THEO_DONVI,:XEM_CAPDUOI,:X' +
        'EM_TUYCHON_NGHIVIEC,'
