inherited frmBAOHIEM_ThietKeMau: TfrmBAOHIEM_ThietKeMau
  Left = 190
  Top = 116
  Width = 1035
  Height = 645
  ...
  object dxlcTop: TdxLayoutControl [1]
    Left = 0
    Top = 0
    Width = 1027
    Height = 233
    ...
    object dxlcTopGroup_Root: TdxLayoutGroup
      ...
      object dxlcTopGroup1: TdxLayoutGroup
        ...
        AlignVert = avClient
        Caption = 'DANH S'#193'CH M'#7850'U'
        ...
        object pageUtility: TElPageControl
          ...
          object tabSystemFunction: TElTabSheet
            ...
            object gridSysFunction: TdxDBGrid
              ...
              Align = alClient
              TabOrder = 0
              OnDblClick = gridSysFunctionDblClick
              OnKeyDown = gridSysFunctionKeyDown
      ...
      object dxlcMain: TdxLayoutControl
        ...
        object dxLayoutGroup2: TdxLayoutGroup
          ...
          object dxlcMainGroup3: TdxLayoutGroup
            ...
            AlignHorz = ahClient
            AlignVert = avClient
            Caption = 'II. '#272#7882'NH NGH'#296'A C'#7896'T ( C'#212'NG TH'#7912'C T'#205'NH) :'
  ...
  object dxBarManager1: TdxBarManager
    ...
    object dxAddColumn: TdxBarButton
      ...
      Align = iaClient
      Caption = 'Th'#234'm c'#7897't'
      Category = 1
      Hint = 'Th'#234'm c'#7897't m'#7899'i v'#224'o b'#7843'ng t'#237'nh b'#7843'o hi'#7875'm'
      Visible = ivAlways
    end
    object dxDeleteColumn: TdxBarButton
      Action = acDelete
      Caption = 'X'#243'a c'#7897't'
      Category = 1
      Hint = 'X'#243'a c'#7897't'
      Visible = ivAlways
    end
    ...
    object dxInsertColumn: TdxBarButton
      ...
      Caption = 'Ch'#232'n c'#7897't m'#7899'i'
      Category = 1
      Hint = 'Ch'#232'n c'#7897't m'#7899'i'
      Visible = ivAlways
    end
  ...
  object qryCongthuc: TIBOQuery
    ...
    DatabaseName = 'E:\SSP_HRM_3.0\Database\SSP_HRM_DB_30.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM HR_BAOHIEM_CONGTHUC'
      'WHERE'
      '   CT_MA = :OLD_CT_MA AND'
      '   MAU_ID = :OLD_MAU_ID')
    EditSQL.Strings = (
      'UPDATE HR_BAOHIEM_CONGTHUC SET'
      '   CT_MA = :CT_MA, /*PK*/'
      '   MAU_ID = :MAU_ID, /*PK*/'
      '   CT_KYHIEU = :CT_KYHIEU,'
      '   CT_TIEUDE = :CT_TIEUDE,'
    ...
    GeneratorLinks.Strings = (
      'CT_MA=gen_hr_baohiem_congthuc_id')
    IB_Connection = dmMain.connMain
    InsertSQL.Strings = (
      'INSERT INTO HR_BAOHIEM_CONGTHUC('
      '   CT_MA, /*PK*/'
      '   MAU_ID, /*PK*/'
      '   CT_KYHIEU,'
      '   CT_TIEUDE,'
    ...
    SQL.Strings = (
      'SELECT HR_BAOHIEM_CONGTHUC.mau_id'
      '     , CT_MA'
      '     , CT_KYHIEU'
      '     , CT_TIEUDE'
      '     , CT_KIEUDULIEU'
      ...
      'left JOIN HR_BAOHIEM_SESSION on '
      '    HR_BAOHIEM_CONGTHUC.mau_id=HR_BAOHIEM_SESSION.mau_id and'
      '    CT_SESSION=S_MA'
  ...
  object qrySession: TIBOQuery
    ...
    Left = 378
    Top = 47
    object qrySessionMAU_ID: TIntegerField
      FieldName = 'MAU_ID'
      Required = True
    end
    ...
    object qrySessionS_EXEC_BEFORE: TIntegerField
  ...
  object qryCongthucKhac: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '     , CT_THUTU_HIENTHI'
      'FROM HR_BAOHIEM_CONGTHUC'
      'where (MAU_ID=:MAU_ID) and'
      '      (CT_KYHIEU <>:CT_KYHIEU) '
      'order by CT_THUTU_HIENTHI')
    FieldOptions = []
    Left = 733
    Top = 365
    object qryCongthucKhacMAU_ID: TIntegerField
      FieldName = 'MAU_ID'
      Required = True
    end
