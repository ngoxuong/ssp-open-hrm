inherited frmTrainingReport: TfrmTrainingReport
  Left = 220
  Top = 232
  Width = 719
  Height = 489
  ...
  object dxLayoutControl1: TdxLayoutControl [1]
    ...
    object pageData: TElPageControl
      ...
      object tabData: TElTabSheet
        ...
        object gridData: TdxDBGrid
          ...
          object gridDataCLASS_NO: TdxDBGridColumn
      ...
      object tabSoluong: TElTabSheet
        ...
        ImageIndex = 8
        TabVisible = True
        Caption = 'Bi'#7875'u '#273#7891' s'#7889' l'#432#7907'ng '#273#224'o t'#7841'o h'#224'ng th'#225'ng'
        Visible = False
        object chartTrainCount: TDBChart
          Left = 0
          Top = 0
          Width = 257
          Height = 165
          ...
          Title.Text.WideStrings = (
            'BI'#7874'U '#272#7890' TH'#7888'NG K'#202' S'#7888' L'#431#7906'NG '#272#192'O T'#7840'O THEO T'#7914'NG TH'#193'NG')
          ...
          LeftAxis.Title.Caption = 'S'#7889' l'#432#7907'ng '#273#224'o t'#7841'o'
      ...
      object tabKetqua: TElTabSheet
        ...
        ImageIndex = 4
        TabVisible = True
        Caption = 'Th'#7889'ng k'#234' k'#7871't qu'#7843' '#273#224'o t'#7841'o'
        Visible = False
        object chartTrainResult: TDBChart
          ...
          Title.Font.Style = [fsBold]
          Title.Text.WideStrings = (
            'BI'#7874'U '#272#7890' TH'#7888'NG K'#202' K'#7870'T QU'#7842' '#272#192'O T'#7840'O')
          BottomAxis.LabelsFont.Charset = ANSI_CHARSET
          BottomAxis.LabelsFont.Name = 'Verdana'
      ...
      object tabNoidungDaotao: TElTabSheet
        ...
        object chartTrainClass: TDBChart
          ...
          Title.Font.Style = [fsBold]
          Title.Text.WideStrings = (
            'BI'#7874'U '#272#7890' TH'#7888'NG K'#202' THEO N'#7896'I DUNG '#272#192'O T'#7840'O')
          BottomAxis.LabelsFont.Charset = ANSI_CHARSET
          BottomAxis.LabelsFont.Name = 'Verdana'
          BottomAxis.Title.Caption = 'N'#7896'I DUNG '#272#192'O T'#7840'O'
          BottomAxis.Title.Font.Color = clBlue
          BottomAxis.Title.Font.Style = [fsBold]
          LeftAxis.Title.Caption = 'S'#7889' l'#432#7907'ng '#273#224'o t'#7841'o'
          LeftAxis.Title.Font.Color = clBlue
    ...
    object dxLayoutControl1Group_Root: TdxLayoutGroup
      ...
      object dxLayoutControl1Group2: TdxLayoutGroup
        ...
        AlignVert = avClient
        Caption = 'D'#7918' LI'#7878'U T'#7892'NG H'#7906'P C'#212'NG T'#193'C HU'#7844'N LUY'#7878'N - '#272#192'O T'#7840'O NH'#194'N VI'#202'N'
  ...
  inherited fcMain: TElFormCaption
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'Th'#7889'ng k'#234' t'#236'nh h'#236'nh hu'#7845'n luy'#7879'n - '#273#224'o t'#7841'o'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 632
  ...
  object qryData: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '     , TYPE_NAME'
      '     , SUPPLY_NAME'
      '     , HR_TRAINING_PLAN.CREATE_DATE'
      '     , HR_TRAINING_PLAN.AT_MONTH'
      '     , HR_TRAINING_PLAN.AT_PERIOD'
      '     , HR_TRAINING_PLAN.AT_YEAR'
    ...
    object qryDataCURRENCY: TWideStringField
      FieldName = 'CURRENCY'
      Size = 30
    end
    ...
    object qryDataCREATE_DATE: TDateField
      FieldName = 'CREATE_DATE'
    end
    object qryDataAT_MONTH: TIntegerField
      FieldName = 'AT_MONTH'
    end
    object qryDataAT_PERIOD: TIntegerField
      FieldName = 'AT_PERIOD'
    end
    object qryDataAT_YEAR: TIntegerField
      FieldName = 'AT_YEAR'
    end
    ...
    object qryDataSTUDENT_COUNT: TIntegerField
    ...
    object qryDataCURRENCY_NAME: TWideStringField
  ...
  object ActionList1: TActionList
    ...
    object acInitTrainCount: TAction
      Caption = 'acInitTrainCount'
      OnExecute = acInitTrainCountExecute
    end
  ...
  object dsTrainCount: TDataSource
    DataSet = memTrainCount
    Left = 54
    Top = 248
  end
  object memTrainCount: TdxMemData
    Indexes = <>
    SortOptions = []
    Left = 54
    Top = 216
    object memTrainCountMONTH: TIntegerField
      FieldName = 'MONTH'
    end
    object memTrainCountYEAR: TIntegerField
      FieldName = 'YEAR'
    end
    object memTrainCountMONTH_YEAR: TWideStringField
      FieldName = 'MONTH_YEAR'
    end
    object memTrainCountCOUNT: TIntegerField
      FieldName = 'COUNT'
    end
  end
  ...
  object memTrainResult: TdxMemData
    ...
    object memTrainResultCOUNT: TIntegerField
      FieldName = 'COUNT'
    end
  end
  object memTrainContent: TdxMemData
    ...
    object memTrainContentCOUNT: TIntegerField
      FieldName = 'COUNT'
    end
  end
