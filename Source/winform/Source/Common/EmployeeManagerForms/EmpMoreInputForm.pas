...
type
  TfrmEmpMoreInput = class(TfrmListBase)
    ...
    dxdbgMainNgaythamgiacm: TdxDBGridDateColumn;
    dxdbgMainNgaychuyendang: TdxDBGridDateColumn;
    dxdbgMainNgayxuatngu: TdxDBGridDateColumn;
    dxdbgMainNgaynhapngu: TdxDBGridDateColumn;
    dxdbgMainTroCap: TdxDBGridCalcColumn;
    dxdbgMainCapuycaonhatdaqua: TdxDBGridColumn;
    dxdbgMainCapuyhiennay: TdxDBGridColumn;
    dxdbgMaindacdiemlichsu: TdxDBGridColumn;
    dxdbgMainSuckhoe: TdxDBGridColumn;
    dxdbgMainLyluanchinhtri: TdxDBGridColumn;
    dxdbgMainQuanham: TdxDBGridColumn;
    qryListNGAY_THAMGIACM: TDateField;
    qryListNGAY_CHUYENDANGCHINHTHUC: TDateField;
    qryListCAPUYCAONHATDAQUA: TWideStringField;
    qryListCAPUYHIENNAY: TWideStringField;
    qryListDACDIEM_LICHSU: TWideStringField;
    qryListSUCKHOE: TWideStringField;
    qryListLYLUAN_CHINHTRI: TWideStringField;
    qryListNGAY_NHAPNGU: TDateField;
    qryListNGAY_XUATNGU: TDateField;
    qryListQUANHAM: TWideStringField;
    qryListTROCAP_XUATNGU: TIBOFloatField;
