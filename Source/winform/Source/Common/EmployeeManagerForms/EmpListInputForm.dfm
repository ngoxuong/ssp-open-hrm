inherited frmEmpListInput: TfrmEmpListInput
  ...
  inherited dxlcMain: TdxLayoutControl
    ...
    inherited dxdbgMain: TdxDBGrid
      ...
      object dxdbgMainAPEC_No: TdxDBGridColumn
        Caption = 'Th'#7867' APEC'
        HeaderAlignment = taCenter
        Width = 116
        BandIndex = 1
        RowIndex = 0
        FieldName = 'Apec_no'
        Caption_UTF7 = 'Th+Hrs APEC'
      end
      object dxdbgMainAPEC_Date: TdxDBGridDateColumn
        Caption = 'Ng'#224'y c'#7845'p th'#7867' APEC'
        HeaderAlignment = taCenter
        Width = 128
        BandIndex = 1
        RowIndex = 0
        FieldName = 'Apec_date'
        Caption_UTF7 = 'Ng+AOA-y c+HqU-p th+Hrs APEC'
      end
      ...
      object dxdbgMainAPEC_EXPIRED: TdxDBGridDateColumn
        Caption = 'Ng'#224'y h'#7871't h'#7841'n th'#7867' APEC'
        HeaderAlignment = taCenter
        Width = 137
        BandIndex = 1
        RowIndex = 0
        FieldName = 'Apec_expired'
        Caption_UTF7 = 'Ng+AOA-y h+Hr8-t h+HqE-n th+Hrs APEC'
      end
  ...
  inherited qryList: TIBOQuery
    ...
    object qryListAPEC_NO: TWideStringField
      FieldName = 'APEC_NO'
      Size = 30
    end
    object qryListAPEC_DATE: TDateField
      FieldName = 'APEC_DATE'
    end
    object qryListAPEC_EXPIRED: TDateField
      FieldName = 'APEC_EXPIRED'
    end
  end
