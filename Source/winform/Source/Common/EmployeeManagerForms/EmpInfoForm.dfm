inherited frmEmpInfo: TfrmEmpInfo
  ...
  inherited dxlcMain: TdxLayoutControl
    ...
    object dxDBEdit27: TdxDBEdit [46]
      Left = 281
      Top = 200
      Width = 70
      Style.BorderColor = 5146545
    ...
    object dxDBDateEdit8: TdxDBDateEdit [47]
      Left = 351
      Top = 200
      Width = 70
      Style.BorderColor = 5146545
    ...
    object dxDBDateEdit9: TdxDBDateEdit [48]
      Left = 488
      Top = 200
      Width = 70
      Style.BorderColor = 5146545
        ...
        object dxlcMainGroup19: TdxLayoutGroup
          ...
          object dxlcMainGroup8: TdxLayoutGroup
            ...
            object dxlcMainGroup11: TdxLayoutGroup
              AutoAligns = [aaHorizontal]
              AlignVert = avClient
              Caption = '* Th'#7867' doanh nh'#226'n APEC (APTC)'
              LookAndFeel = dmMain.StyleWeb
              ShowCaption = False
              Hidden = True
              LayoutDirection = ldHorizontal
              ...
              object dxlcMainItem47: TdxLayoutItem
                AutoAligns = [aaVertical]
                Caption = 'S'#7889' th'#7867' APEC/c'#7845'p ng'#224'y'
                Control = dxDBEdit27
                ControlOptions.ShowBorder = False
              end
