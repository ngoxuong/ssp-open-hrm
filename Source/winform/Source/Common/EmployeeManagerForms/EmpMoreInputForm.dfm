inherited frmEmpMoreInput: TfrmEmpMoreInput
  ...
  inherited dxlcMain: TdxLayoutControl
    ...
    inherited dxdbgMain: TdxDBGrid
      ...
      object dxdbgMainNgaychuyendang: TdxDBGridDateColumn
        ...
        Caption_UTF7 = 'Ng+AOA-y v+AOA-o +ARAeow-ng ch+AO0-nh th+Huk-c'
      end
      ...
      object dxdbgMainNgaythamgiacm: TdxDBGridDateColumn
        ...
        Caption_UTF7 = 'Ng+AOA-y tham gia c+AOE-ch m+HqE-ng'
      end
      object dxdbgMainCapuycaonhatdaqua: TdxDBGridColumn
        ...
        Caption_UTF7 = 'C+HqU-p +Huc-y cao nh+HqU-t +AREA4w qua'
      end
      object dxdbgMainCapuyhiennay: TdxDBGridColumn
        ...
        Caption_UTF7 = 'C+HqU-p +Huc-y hi+Hsc-n nay'
      end
      object dxdbgMaindacdiemlichsu: TdxDBGridColumn
        ...
        Caption_UTF7 = '+ARAetw-c +ARE-i+HsM-m l+Hss-ch s+Hu0'
      end
      object dxdbgMainSuckhoe: TdxDBGridColumn
        ...
        RowIndex = 0
        FieldName = 'SUCKHOE'
        Caption_UTF7 = 'S+Huk-c kh+Hs8-e'
      end
      object dxdbgMainLyluanchinhtri: TdxDBGridColumn
        ...
        Caption_UTF7 = 'L+AP0 lu+Hq0-n ch+AO0-nh tr+Hss'
      end
      object dxdbgMainNgaynhapngu: TdxDBGridDateColumn
        ...
        Caption_UTF7 = 'Ng+AOA-y nh+Hq0-p ng+AWk'
      end
      object dxdbgMainNgayxuatngu: TdxDBGridDateColumn
        ...
        Caption_UTF7 = 'Ng+AOA-y Xu+HqU-t Ng+AWk'
      end
      object dxdbgMainQuanham: TdxDBGridColumn
        Caption = 'Qu'#226'n H'#224'm'
        HeaderAlignment = taCenter
        Width = 138
        BandIndex = 2
        RowIndex = 0
        FieldName = 'QUANHAM'
        Caption_UTF7 = 'Qu+AOI-n H+AOA-m'
      end
      object dxdbgMainTroCap: TdxDBGridCalcColumn
        Caption = 'Tr'#7907' C'#7845'p'
        HeaderAlignment = taCenter
        Width = 104
        BandIndex = 2
        RowIndex = 0
        FieldName = 'TROCAP_XUATNGU'
        Caption_UTF7 = 'Tr+HuM C+HqU-p'
      end
    end
  ...
  inherited qryList: TIBOQuery
    ...
    SQL.Strings = (
      ...
      '     , CAN_NANG'
      '     , DAUVET_DACBIET'
      '     , HR_EMP_PRIVATE_INFO.NGAY_THAMGIACM'
      '     , HR_EMP_PRIVATE_INFO.NGAY_CHUYENDANGCHINHTHUC'
      '     , HR_EMP_PRIVATE_INFO.CAPUYCAONHATDAQUA'
      '     , HR_EMP_PRIVATE_INFO.CAPUYHIENNAY'
      '     , HR_EMP_PRIVATE_INFO.DACDIEM_LICHSU'
      '     , HR_EMP_PRIVATE_INFO.SUCKHOE'
      '     , HR_EMP_PRIVATE_INFO.LYLUAN_CHINHTRI'
      '     , HR_EMP_PRIVATE_INFO.NGAY_NHAPNGU'
      '     , HR_EMP_PRIVATE_INFO.NGAY_XUATNGU'
      '     , HR_EMP_PRIVATE_INFO.QUANHAM'
      '     , HR_EMP_PRIVATE_INFO.TROCAP_XUATNGU'
    ...
    object qryListNGAY_THAMGIACM: TDateField
      FieldName = 'NGAY_THAMGIACM'
    end
    object qryListNGAY_CHUYENDANGCHINHTHUC: TDateField
      FieldName = 'NGAY_CHUYENDANGCHINHTHUC'
    end
    object qryListCAPUYCAONHATDAQUA: TWideStringField
      FieldName = 'CAPUYCAONHATDAQUA'
      Size = 300
    end
    object qryListCAPUYHIENNAY: TWideStringField
      FieldName = 'CAPUYHIENNAY'
      Size = 300
    end
    object qryListDACDIEM_LICHSU: TWideStringField
      FieldName = 'DACDIEM_LICHSU'
      Size = 300
    end
    object qryListSUCKHOE: TWideStringField
      FieldName = 'SUCKHOE'
      Size = 300
    end
    object qryListLYLUAN_CHINHTRI: TWideStringField
      FieldName = 'LYLUAN_CHINHTRI'
      Size = 300
    end
    object qryListNGAY_NHAPNGU: TDateField
      FieldName = 'NGAY_NHAPNGU'
    end
    object qryListNGAY_XUATNGU: TDateField
      FieldName = 'NGAY_XUATNGU'
    end
    object qryListQUANHAM: TWideStringField
      FieldName = 'QUANHAM'
      Size = 300
    end
    object qryListTROCAP_XUATNGU: TIBOFloatField
      FieldName = 'TROCAP_XUATNGU'
    end
  end
